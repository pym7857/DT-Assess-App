...
def index():
    ...
    if request.method == 'POST':
        ...
        return render_template('index.html', sdict=sdict, err_msg=err_msg, who=who, url_logo=url_logo, chk_num_text=chk_num_text)
...
def start():
    ...
    if request.method == 'POST':
        ...
        return render_template('index.html', who=who, url_logo=url_logo)
...
if __name__ == "__main__":
    ...
    dic = {'조욱동 이사': 0, '김정옥 이사': 0, '서장철 담당(DP)': 0, '서장철 담당(DT)': 0, '박경록 담당': 0}
    who = ""
